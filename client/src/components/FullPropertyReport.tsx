      ...
      <div className="bg-[#0F172A] text-white">
        <div className="max-w-5xl mx-auto px-4 py-12">
          ...
          <div className="flex items-center justify-between mb-10">
            {onBack && (
              <button onClick={onBack} className="inline-flex items-center gap-2 text-white/60 hover:text-white transition-colors text-sm">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <span className="text-white/40 text-sm ml-3">Full Property Report</span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4 text-sm text-white/50 mb-8">
            ...
            {prepared_for && (
              <>
                <span>•</span>
                <span>Prepared for: <strong className="text-white/70">{prepared_for}</strong></span>
              </>
            )}
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
              <p className="text-white/50 text-xs uppercase tracking-wider mb-1">Est. Annual Revenue</p>
            ...
            <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
              <p className="text-white/50 text-xs uppercase tracking-wider mb-1">Avg. Nightly Rate</p>
              <p className="text-2xl font-serif font-bold text-white">{formatCurrency(revenue_estimate.nightly)}</p>
            </div>
            <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
              <p className="text-white/50 text-xs uppercase tracking-wider mb-1">Occupancy Rate</p>
              <p className="text-2xl font-serif font-bold text-white">{formatPercent(revenue_estimate.occupancy)}</p>
            </div>
            <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
              <p className="text-white/50 text-xs uppercase tracking-wider mb-1">Monthly Average</p>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-[#0F172A]/70 leading-relaxed">
                    ...
                    and an average nightly rate of <strong>{formatCurrency(revenue_estimate.nightly)}</strong>.
                    {revenue_estimate.range && (
                ...
                <div>
                  ...
                  <p className="text-[#0F172A]/70 leading-relaxed">
                    ...
                    {displayComps.length > 0 && (
                      ...
                      The average comparable revenue is {formatCurrency(displayComps.reduce((s, c) => s + c.annual_revenue, 0) / displayComps.length)}.
                      {(() => {
                        const rated = displayComps.filter(c => c.rating && c.rating > 0);
                        if (rated.length > 0) {
                ...
                {hasPurchase && purchaseCalcs && (
                  <div>
                    ...
                    <p className="text-[#0F172A]/70 leading-relaxed">
                      ...
                      a cash-on-cash return of <strong>{purchaseCalcs.cashOnCash.toFixed(1)}%</strong>.
