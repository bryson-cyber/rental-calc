                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <CardTitle className="text-lg">Launch Action Plan</CardTitle>
                        <CardDescription>Step-by-step guide to get started</CardDescription>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      <Badge variant="outline">{result.actionPlan.totalTimeline}</Badge>
                      {expandedSections.action ? <ChevronUp className="w-5 h-5" /> : <ChevronDown className="w-5 h-5" />}
                    </div>
                  </div>
                </CardHeader>
                  ...
                  <CardContent className="space-y-6">
                    <div className="flex items-center gap-4 p-4 bg-muted rounded-lg">
                      <div>
                        ...
                        <p className="font-semibold">{result.actionPlan.totalTimeline}</p>
                      </div>
                      <div className="h-8 w-px bg-border" />
                      <div>
                        <p className="text-sm text-muted-foreground">Estimated Budget</p>
                        <p className="font-semibold">{result.actionPlan.totalBudget}</p>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {result.actionPlan.criticalPath.map((item, i) => (
                    ...
                    <div className="space-y-4">
                      {result.actionPlan.phases.map((phase, i) => (
                            ...
                            {phase.tasks.map((task, j) => (
                              <div key={j} className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                  ...
                                  {task.estimatedCost && (
                                    <p className="text-xs text-muted-foreground">{task.estimatedCost}</p>
                                  )}
                                </div>
                              </div>
                            ))}
                              ...
                              <div className="pt-2 border-t">
                                ...
                                <div className="flex flex-wrap gap-1">
                                  {phase.milestones.map((m, k) => (
                                    <Badge key={k} variant="secondary" className="text-xs">{m}</Badge>
                                  ))}
                                </div>
                              </div>
                            )}
