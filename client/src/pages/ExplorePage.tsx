/**
 * ExplorePage — Public Lead Validation Page
 *
 * A simplified, public-facing page that lets leads:
 * 1. Search for a market (city, neighborhood, zip code)
 * 2. Browse rental property listings with revenue data
 * 3. Run ONE free deep property analysis (cookie-limited)
 *
 * No login required. TOS acceptance required before interaction.
 * Designed to be shared via a single link during sales conversations.
 */
    ...
    <div className="min-h-screen bg-gradient-to-br from-[oklch(0.98_0.005_265)] to-[oklch(0.95_0.01_265)]">
      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-[oklch(0.90_0_0)] sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <a
            href="/"
            className="text-sm text-[oklch(0.55_0.14_75)] hover:underline font-medium"
          >
            Get Full Access →
          </a>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-4 pt-8 pb-4">
        <div className="text-center mb-6">
          ...
          <p className="text-[oklch(0.45_0_0)] max-w-lg mx-auto">
            Search any city, neighborhood, or zip code to see real Airbnb revenue data
          </p>
        </div>
      ...
      {/* Footer */}
      <footer className="bg-white border-t border-[oklch(0.92_0_0)] py-8 mt-8">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <p className="text-sm text-[oklch(0.50_0_0)] mb-3">
            Want unlimited analyses and full market reports?
          </p>
          <a
            href="/"
            className="inline-flex items-center gap-2 bg-gradient-to-r from-[oklch(0.55_0.14_75)] to-[oklch(0.50_0.14_75)] text-white px-6 py-3 rounded-xl font-semibold hover:opacity-90 transition-opacity shadow-md"
          >
            Get Your Free Revenue Estimate
            <ChevronDown className="w-4 h-4 rotate-[-90deg]" />
          </a>
          <p className="text-xs text-[oklch(0.60_0_0)] mt-4">
            Data powered by AirDNA · Estimates are for informational purposes only
          </p>
        </div>
      </footer>
    </div>
      ...
      <div className="p-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={deepAnalysisUsed || isAnalyzing}
            className={`flex-1 flex items-center justify-center gap-1.5 text-xs font-semibold rounded-lg py-2 transition-all ${
              deepAnalysisUsed
                ? 'bg-[oklch(0.93_0_0)] text-[oklch(0.60_0_0)] cursor-not-allowed'
                : 'bg-gradient-to-r from-[oklch(0.50_0.15_300)] to-[oklch(0.45_0.15_280)] text-white hover:opacity-90 shadow-sm'
            }`}
          >
            {isAnalyzing ? (
              <>
    ...
    <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-5">
          ...
          {/* CTA */}
          <div className="bg-gradient-to-r from-[oklch(0.97_0.01_75)] to-[oklch(0.95_0.02_75)] rounded-xl p-4 border border-[oklch(0.90_0.05_75)]">
            <p className="text-sm font-semibold text-[oklch(0.30_0_0)] mb-1">
              Want the full breakdown?
            </p>
            <p className="text-xs text-[oklch(0.45_0_0)] mb-3">
              Get detailed market analysis, competitor data, seasonality trends, and a professional report.
            </p>
            <a
              href="/"
              className="inline-flex items-center gap-2 bg-[oklch(0.55_0.14_75)] text-white text-sm font-semibold px-5 py-2.5 rounded-xl hover:opacity-90 transition-opacity"
            >
