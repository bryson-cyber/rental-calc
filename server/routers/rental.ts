...
import { generateEnhancedPropertyReport } from "../report-generator";
...
import { canPerformAnalysis, canPerformValidation, recordAnalysisUsage, recordValidateUsage } from "../usage-limits";
    ...
    getAIPropertyReport: adminProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        try {
          ...
          // Fallback: use BNB Calc comps from the comprehensive report when no market ID
          if (allCompetitors.length === 0 && baseReport.same_bedroom_comps.length > 0) {
            ...
            console.log(`[getAIPropertyReport] Using ${allCompetitors.length} BNB Calc comps (no market ID), ${qualifyingCompetitors.length} qualify`);
          }
          ...
          const result = {
            ...
            data: {
              ...
              airdna_native_comps: undefined, // Removed - AirDNA no longer available
