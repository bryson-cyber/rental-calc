...
describe('Risk Assessment Generation', () => {
  it('should generate a complete risk assessment (120-150 words)', async () => {
...
Be specific and direct. Quantify risks where possible. This is expert risk analysis.`;
    ...
    const response = await generateNarrativeWithPoe(prompt, {
      ...
      maxTokens: 1500, // Increased from 600
      timeoutMs: 45000,
    });
    ...
    expect(response.length).toBeGreaterThan(300); // Should be at least 300 chars for 120+ words
