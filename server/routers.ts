...
import { leads, savedSearches, favoriteProperties, analysisReports, favoriteMarkets, marketAlerts, sharedReports, aiAdvisorCache, notifications, favoriteListings, savedRegulations, regulationComments, commentVotes, users, emailOptins, personalizedLinks, linkClicks, promotions, promotionRecipients, toolUsageEvents } from "../drizzle/schema";
