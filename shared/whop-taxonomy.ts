/**
 * Generated from Whop's Business Types & Industries documentation.
 * Source: https://docs.whop.com/api-reference/beta/business-types
 * API version reviewed: 2026-07-08-1
 * Do not edit by hand; run scripts/generate-whop-taxonomy.mjs instead.
 */
export const WHOP_BUSINESS_TAXONOMY = {
...
export type WhopBusinessType = keyof typeof WHOP_BUSINESS_TAXONOMY;
export type WhopIndustryGroup<T extends WhopBusinessType = WhopBusinessType> =
  keyof (typeof WHOP_BUSINESS_TAXONOMY)[T];

export function isValidWhopTaxonomySelection(
  businessType: string,
  industryGroup: string,
  industryType: string,
): boolean {
  const groups = WHOP_BUSINESS_TAXONOMY[businessType as WhopBusinessType] as
    | Record<string, readonly string[]>
    | undefined;
  return Boolean(groups?.[industryGroup]?.includes(industryType));
}

export function humanizeWhopTaxonomyValue(value: string): string {
  return value
    .split("_")
